...
enum Synology {
    ...
    actor Client {
         ...
         */
        @discardableResult
        func getAPIs() async throws -> [String: API] {
        ...
        /**
         ...
         - Throws: Throws a ``SynologyErrors`` error if an API error occurs.
         */
        func createTask(urls: [URL]) async throws {
        ...
        private func makeURLComponents(api: String, method: String, version: UInt, authenticated: Bool = true, queryParameters: Parameters? = nil) throws -> URLComponents {
            guard let APIs else { throw SynologyErrors.APIInfoNotDownloaded }
        ...
        @discardableResult
        private func executeRequest<T: Decodable>(_ request: URLRequest, decoder _: T.Type) async throws -> T {
